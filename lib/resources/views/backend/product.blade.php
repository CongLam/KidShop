                                ...
                                <tbody>
                                    @foreach ($productList as $prod)
                                        <tr>
                                            ...
                                            <td>{{number_format( $prod->product_price,0,',','.') }}VNĐ</td>
                                            <td>
                                                <img width="200px" src="{{ asset('lib/storage/app/avatar/'.$prod->product_img) }}" class="thumbnail">
                                            </td>
                                            <td>{{ $prod->cate_name }}</td>
                                            <td>
                                                <a href="{{ asset('admin/product/edit/'.$prod->product_id) }}" class="btn btn-warning"><i class="fa fa-pencil" aria-hidden="true"></i> Sửa</a>
