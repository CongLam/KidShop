					...
					<div class="col-sm-6">
						<div class="your-order">
							...
							<div class="your-order-body" style="padding: 0px 10px">
								<div class="your-order-item">
                                        @foreach ($items as $item)
                                            ...
                                            <!--  one item	 -->
                                                <div class="media">
                                                    <img width="15%" src="{{ asset('lib/storage/app/avatar/'.$item->options->img) }}" alt="" class="pull-left">
                                                    <div class="media-body">
                                                        <p class="font-large">{{ $item->name }}</p>
                                                        <span class="color-gray your-order-info">Số lượng: {{ $item->qty }}</span>
                                                        <span class="color-gray your-order-info">Giá: {{ number_format($item->price*$item->qty,0,',','.') }} VNĐ</span>
                                                    </div>
                                                    <hr>
                                                </div>
                                            <!-- end one item -->
								...
								<div class="your-order-item">
									...
									<div class="pull-right"><h5 class="color-black">{{ $totalPrice}}VNĐ</h5></div>
									<div class="clearfix"></div>
								</div>
							</div>
							...
							<div class="text-center">
                                {{-- <a class="beta-btn primary" type="submit" href="#">Đặt hàng <i class="fa fa-chevron-right"></i></a> --}}
                                <input class="beta-btn primary" type="submit" value="Đặt hàng">
                            </div>
						</div> <!-- .your-order -->
					</div>
				</div>
